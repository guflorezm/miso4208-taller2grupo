    ...
    var horde = window.gremlins.createHorde()
		    .allGremlins()
				...
				.canClick( function (element) {
					// Intenta hacer click sobre botones y links, radiobutton y checkboxes
					return element.tagName.toLowerCase() === 'a' || element.tagName.toLowerCase() === 'button' || element.type.toLowerCase() === 'radio' || element.type.toLowerCase() === 'checkbox';
				}))
				// Le da igual prioridad
